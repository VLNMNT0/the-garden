local ToySanta, super = Class(Event)

function ToySanta:init(data)
...
function ToySanta:onInteract(player, dir)
	self.timer = 0
	self.loop_timer = 0
	self.con = 0
...
function ToySanta:onRemove(parent)
